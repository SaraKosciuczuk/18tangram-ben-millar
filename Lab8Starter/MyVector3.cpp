...
MyVector3 MyVector3::unit() const
{
	...
	if (vectorLenght != 0.0 )
	{
		const double unitX = x / vectorLenght;
		const double unitY = y / vectorLenght;
		const double unitZ = z / vectorLenght;
...
{
	double lenghtSq = t_other.lengthSquared();
